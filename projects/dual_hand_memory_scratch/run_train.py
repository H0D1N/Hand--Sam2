"""训练完整 Memory 子系统随机初始化的双手 SAM2 模型。"""
...
from .builder import build_sam2_dual_hand_memory_scratch_tiny, configure_memory_scratch_training
from projects.dual_hand_memory.dataset import build_dataloaders
...
def parse_args() -> argparse.Namespace:
    ...
    """
    parser = argparse.ArgumentParser(description="Train dual-hand SAM2 with randomly initialized Memory.")
...
def main() -> None:
    ...
    # 模型
    model = build_sam2_dual_hand_memory_scratch_tiny(
    ...
    configure_memory_scratch_training(model, args.finetune_mode)
